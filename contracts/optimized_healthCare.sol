...
contract optimized_healthCare {
  ...
  //setting the owner
  constructor() public {
    owner = 0xf555E841808055fFbC898cB9C334D9dF127386A5;
  }
  ...
  function signupPatient(string memory _name, string memory _contact, string memory _gender) public {
   ...
   // require(!(p.id > address(0x0)),"pid invaIid");
    //Add patient to blockchain
    //require(a.adhaar_number > 0,"addhar number err0r");
  ...
  function addDoctorAdhaarInfo(address _doc, string memory _name, string memory _DOB, uint24 _pincode, uint64 _adhaar_number,string memory _contact, string memory _gender) public {
    adhaar memory a = doctor_adhaar_info[_doc];
    //require(a.adhaar_number == 0,"aadhar err");
    doctor_adhaar_info[_doc] = adhaar({id:_doc, pincode: _pincode, name: _name, DOB: _DOB, adhaar_number: _adhaar_number});
    signupDoctor(_doc, _name, _contact, "");
  }

  function addPatientAdhaarInfo(address _pat, string memory _name, string memory _DOB, uint24 _pincode, uint64 _adhaar_number,string memory _contact, string memory _gender) public {
    adhaar memory a = patient_adhaar_info[_pat];
    //(a.adhaar_number == 0,"aadhar err");
    patient_adhaar_info[_pat] = adhaar({id:_pat, pincode: _pincode, name: _name, DOB: _DOB, adhaar_number: _adhaar_number});
    signupPatient(_name, _contact, _gender);
  }
